...
from AliciaRobot.pyrogramee.pluginshelper import unzip
...
async def cat_meme(topString, bottomString, filename, endname):
    ...
    font = ImageFont.truetype("./AliciaRobot/resources/Russo.ttf", fontSize)
...
async def cat_meeme(upper_text, lower_text, picture_name, endname):
    ...
    text_draw = Drawing()
    text_draw.font = join(getcwd(), "./AliciaRobot/resources/Russo.ttf")
